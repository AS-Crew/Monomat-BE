...
import io.github.ascrew.monomatbe.common.constant.RedisKey;
...
public class LobbyRepositoryImpl implements LobbyRepository {
    ...
    for (String code : publicLobbyCodes) {
      ...
      if (!data.isEmpty()) {
        result.add(LobbyRedisDto.builder()
                ...
                .mapId(getLongValue(data.get("map_id")))
                .maxPlayers(getIntegerValue(data.get("max_players")))
                .is(getBooleanValue(data.get("is")))
  ...
  private Boolean getBooleanValue(Object value) {
      return switch (value) {
          ...
          case String text when !text.isBlank() -> Boolean.parseBoolean(text);
          case null, default -> null;
      };
  }
}
